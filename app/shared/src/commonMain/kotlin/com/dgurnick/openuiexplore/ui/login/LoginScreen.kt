...
fun LoginScreen(
    ...
    LaunchedEffect(state) { if (state is LoginState.Success) onSuccess() }
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Column(
            ...
            OutlinedTextField(
                    ...
                    keyboardActions =
                            KeyboardActions(onDone = { if (canSubmit) onLogin(username, password) })
            )
            ...
            TextButton(
                    onClick = { onLogin("john.doe", "guest") },
                    enabled = !isLoading,
                    modifier = Modifier.fillMaxWidth()
